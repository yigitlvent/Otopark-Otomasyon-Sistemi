...
{
    public partial class Site_Konum_A : Form
    {
        public Site_Konum_A()
        {
            InitializeComponent();
        ...
        private void Site_Konum_A_Load(object sender, EventArgs e)
        {
            Kullanıcı_Girişi.baglanti.Open();
            SqlCommand komut = new SqlCommand("Select site.Oplaka,siteA.Odaire from siteA,site where siteA.Oblok=site.Oblok and siteA.Odurum=1", Kullanıcı_Girişi.baglanti);
